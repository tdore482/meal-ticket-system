   ...
   async function runReconciliation() {
     ...
     try {
       ...
       if (data.isHealthy) {
         ...
         issuesHTML += `<p style="color:#991b1b; font-weight:700; margin-bottom:8px;">⚠️ ${data.issueCount} Issue(s) Found</p>`;
...
- ⚠️ `meal_allocations.remaining` field still being updated but not used
